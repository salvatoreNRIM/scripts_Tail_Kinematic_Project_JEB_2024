...
void loop()
{
  RampToVelocity(250,4000);  //Ramp to 1000 RPM in 2 sec
  delay(DwellTime);
   RampToVelocity(0,3000);    //Ramp to 0 RPM in 1 sec
  delay(DwellTime);
   RampToVelocity(-100,3000);  //Ramp to -500 RPM in .1 sec
   delay(DwellTime);
  DoSinusoid(100,3000);       //Do a sinusoidal profile with an amplitude of 500 RPM in 1 sec
  delay(DwellTime);
   RampToVelocity(3000);      //Ramp to 1000 RPM as fast as possible
  delay(DwellTime);
   RampToVelocity(3000);         //Ramp to 0 RPM as fast as possible
  delay(DwellTime);
 DoSinusoid(100,3000);       //Do a sinusoidal profile with an amplitude of 1000 RPM in 1 sec
   delay(DwellTime);
}
